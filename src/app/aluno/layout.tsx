...
const nav = [
  { href: '/aluno/painel',    icon: '⚡', label: 'Painel' },
  { href: '/aluno/sessao',    icon: '⏱', label: 'Estudar' },
  { href: '/aluno/tutor',     icon: '🤖', label: 'Tutor IA' },
  { href: '/aluno/redacao',   icon: '✍️', label: 'Redação' },
  { href: '/aluno/questoes',  icon: '🎯', label: 'Questões' },
  { href: '/aluno/progresso', icon: '📊', label: 'Progresso' },
  { href: '/aluno/historico', icon: '📋', label: 'Histórico' },
]
    ...
    <div className="flex min-h-screen">
      <aside className="w-56 flex-shrink-0 border-r border-white/8 flex flex-col bg-surface2 fixed h-full z-10">
        <div className="flex items-center gap-2 px-5 py-5 border-b border-white/8">
          <div className="w-2 h-2 rounded-full bg-accent shadow-[0_0_8px_#00e5a0]" />
